...
public class OutlineSettings : ScriptableObject {
    ...
    [Space]
    [Tooltip("Whether to use depth information to draw outlines. This adds lines around objects " +
             "that are in front of other objects.")]
    ...
    [Tooltip("Whether to use color information to draw outlines. This adds lines where the color " +
    ...
    [Space]
    [Min(0)]
    [Tooltip("Minimum difference in color between two pixels to be considered an edge. The outline is drawn almost transparent.")]
    public float minColorThreshold = 0f;
    [Min(0)]
    [Tooltip("Maximum difference in color between two pixels to be considered an edge. The outline is drawn fully opaque.")]
